        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, danke für Ihre Bestellung!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">Vielen Dank, informationen gespeichert.</h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        ...
                        <br>
                        Ihr Paket ist fast auf dem Weg zu Ihnen. Bitte stellen Sie sicher, dass Sie Ihre Telefonnummer korrekt eingegeben und den Anruf von unserem Mitarbeiter beantwortet haben, um die Details zu bestätigen.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">Bitte überprüfen Sie Ihre Kontaktinformationen:</h3>
                <div class="list-info">
                ...
                <p class="success-page__message_fail">
                    <a class="success-page__message_fail__link" href="javascript:history.back()">
                        Wenn Sie einen Fehler gemacht haben, gehen Sie zurück und füllen Sie das Formular erneut aus.
                    </a>
                </p>
                <h3 class="success-page__text" id="lowerH">
                    Um den Bestellprozess zu beschleunigen, bitte geben Sie Ihre Lieferadresse hier ein:
                </h3>
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            <label for="" class="success-page__form__label">Adresse</label>
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> Senden </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>E-Mail und/oder Adresse erforderlich!</span>" +
